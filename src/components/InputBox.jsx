...
function InputBox({
  ...
  return (
    <div className={`bg-white p-3 rounded-lg text-sm flex  ${className} `} >
      ...
      <input id={amountInputId} className='outline-none w-full bg-transparent py-1.5' type='number' placeholder='Amount' disabled={amountDisable} value={amount} onChange={(e) => onAmountChange && onAmountChange(e.target.value)}  />
      </div>
